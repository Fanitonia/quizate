...
- OpenAPI Specification Dosyası: [openapi.yaml](openapi.yaml)
      ...
      parameters:
        ...
        - name: user
          ...
          schema:
            type: string
            format: uuid
          description: Filter quizzes by creator user id.
        - name: topic
          in: query
          schema:
            type: string
          description: Filter quizzes by topic name or slug.
        - name: keyword
          in: query
          schema:
            type: string
          ...
          content:
            application/json:
              schema:
                type: array
                items:
                  $ref: "#/components/schemas/QuizTypeResponse"
    post:
      tags:
        - QuizType
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: "#/components/schemas/CreateQuizTypeRequest"
          text/json:
            schema:
              $ref: "#/components/schemas/CreateQuizTypeRequest"
          application/*+json:
    ...
    put:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: "#/components/schemas/UpdateQuizTypeRequest"
          text/json:
            schema:
              $ref: "#/components/schemas/UpdateQuizTypeRequest"
          application/*+json:
...
components:
  schemas:
    ...
    QuestionObject:
      ...
      type: object
      anyOf:
        - $ref: "#/components/schemas/QuestionObjectMultipleChoiceQuestionObject"
      discriminator:
        propertyName: type
        mapping:
          multiple_choice: "#/components/schemas/QuestionObjectMultipleChoiceQuestionObject"
    QuestionObjectMultipleChoiceQuestionObject:
      required:
        - title
        - options
      properties:
  ...
  securitySchemes:
    CookieAuth:
      type: http
      description: JWT is stored in HttpOnly cookie set by /auth/login and
        /auth/refreshToken.
      scheme: cookie
tags:
  - name: Auth
